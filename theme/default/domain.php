...
var axPath = '<?php createLink('domains'); ?>';
         ...
         <div id="overview">
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <a href="<?php createLink('site-vs-site/'.$my_url_host); ?>" id="pdfLink" class="btn btn-violet btn-sm"> <i class="fa fa-star-half-empty"></i> <?php trans('Compare',$lang['196']); ?> </a>
...
<!-- App -->
<?php if($updateFound) { ?>
<script src="<?php themeLink('js/domain.js'); ?>" type="text/javascript"></script>
<?php } else { ?>
<script src="<?php themeLink('js/dbdomain.js'); ?>" type="text/javascript"></script>
<?php } ?>