            ...
            <?php if(isset($msg)) echo $msg; ?>
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?php echo $taskData['maxcount']; ?>" required="" type="number" class="form-control" name="maxcount" />
                    </div>
         ...
         <div class="box box-danger">
            ...
            <div class="box-body">
                  <table id="seoToolTable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php if(count($taskData[$date]['banned']) == 0){
                        echo '<tr><td colspan="3" class="text-center">List Empty!</td></tr>';
                    }else{
                        foreach($taskData[$date]['banned'] as $bannedKey => $bannedIp){                
                            echo '<tr>
                            <td>'.$bannedIp.'</td>
                            <td>'.$date.'</td>
                            <td><a class="btn btn-danger btn-xs" onclick="return confirm(\'Are you sure you want to delete this item?\');" title="Delete" href='.adminLink($controller.'/delete/'.$bannedKey,true).'> <i class="fa fa-trash-o"></i> &nbsp; Delete </a></td>
                          </tr>';
                        }
                    }
                    ?>
