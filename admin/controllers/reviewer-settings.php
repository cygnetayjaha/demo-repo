...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(!isset($msg)){
        ...
        $query = "UPDATE reviewer_settings SET free_limit='$free_limit', domain_data='$domainDataStr', reviewer_list='$reviewer_listStr', pdf_data='$pdfData', compare_data='$compareDataStr', snap_service='$snapStr' WHERE id='1'";
