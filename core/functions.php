 ...
 * Load All Models
 */
require MOD_DIR . 'alldomains.php';
require MOD_DIR . 'bootpagination.php';
require MOD_DIR . 'comhistory.php';
require MOD_DIR . 'domainAvailability.php';
require MOD_DIR . 'domainhistory.php';
require MOD_DIR . 'html2pdf.php';
require MOD_DIR . 'index.php';
require MOD_DIR . 'kd.php';
require MOD_DIR . 'pagination.php';
require MOD_DIR . 'phpmailer.php';
require MOD_DIR . 'pop3.php';
require MOD_DIR . 'sitemap.php';
require MOD_DIR . 'smtp.php';
require MOD_DIR . 'socialcount.php';
require MOD_DIR . 'ssppage.php';
require MOD_DIR . 'sspuser.php';
require MOD_DIR . 'txtConversion.php';
require MOD_DIR . 'typos.php';
require MOD_DIR . 'uploadhandler.php';
require MOD_DIR . 'whois.php';



require APP_DIR . 'helpers' . DIRECTORY_SEPARATOR . 'UserAgentParser_helper.php';

require APP_DIR . 'helpers' . DIRECTORY_SEPARATOR . 'admin_interface_helper.php';
require APP_DIR . 'helpers' . DIRECTORY_SEPARATOR . 'alexa_helper.php';
require APP_DIR . 'helpers' . DIRECTORY_SEPARATOR . 'cap_helper.php';
require APP_DIR . 'helpers' . DIRECTORY_SEPARATOR . 'compressiontest_helper.php';
require APP_DIR . 'helpers' . DIRECTORY_SEPARATOR . 'country_code_helper.php';
require APP_DIR . 'helpers' . DIRECTORY_SEPARATOR . 'database_helper.php';


require APP_DIR . 'helpers' . DIRECTORY_SEPARATOR . 'extended_helper.php';


require APP_DIR . 'helpers' . DIRECTORY_SEPARATOR . 'geoInfo_helper.php';
require APP_DIR . 'helpers' . DIRECTORY_SEPARATOR . 'google_index_helper.php';
require APP_DIR . 'helpers' . DIRECTORY_SEPARATOR . 'host_info_helper.php';
require APP_DIR . 'helpers' . DIRECTORY_SEPARATOR . 'interface_helper.php';
require APP_DIR . 'helpers' . DIRECTORY_SEPARATOR . 'lang_code_helper.php';
require APP_DIR . 'helpers' . DIRECTORY_SEPARATOR . 'mail_helper.php';
require APP_DIR . 'helpers' . DIRECTORY_SEPARATOR . 'page_speed_insight_helper.php';
require APP_DIR . 'helpers' . DIRECTORY_SEPARATOR . 'rainbow_track_helper.php';
require APP_DIR . 'helpers' . DIRECTORY_SEPARATOR . 'recaptcha_helper.php';
require APP_DIR . 'helpers' . DIRECTORY_SEPARATOR . 'safe_browser_helper.php';
require APP_DIR . 'helpers' . DIRECTORY_SEPARATOR . 'site_snapshot_helper.php';
require APP_DIR . 'helpers' . DIRECTORY_SEPARATOR . 'website_review_helper.php';
