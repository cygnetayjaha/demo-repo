...
defined('PDF_DOMAIN') or die(header('HTTP/1.0 403 Forbidden'));
...
if($data !== false){
    ...
    $seoBox44 = $socialMsg.'<br />
            <br>'.$facebookIcon.' Facebook Likes: '.$facebook_like.'<br>
            <br>'.$plusoneIcon.' PlusOne: '.$gplus_count.'<br>
            <br>'.$stumbleuponIcon.' StumbleUpon: '.$stumble_count.'<br>
            <br>'.$linkedinIcon.' LinkedIn: '.$linkedin_count.'<br>
        <br /><br />';
